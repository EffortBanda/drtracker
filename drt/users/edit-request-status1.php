...
header('location:manage-requests3.php');
}
}
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>User | Finalise Data request Details</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">User | Finalise Data request details Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>User</span>
...
<div class="form-group">
															<label for="date_of_data_submission">
																 Date Of Submission
															</label>
	<input type="date" required="true" name="date_of_data_submission" class="form-control" value="<?php echo htmlentities($data['date_of_data_submission']);?>" >
														</div>
														
<div class="form-group">
															<label for="extraction_script_used">
																 Extraction Script Used
															</label>
	<input type="file" required="true" accept=".doc,.docx,.sql,.txt,.pdf" name="extraction_script_used" class="form-control" value="<?php echo htmlentities($data['extraction_script_used']);?>" >
														</div>
